...
class OncePemesananResponse {
    ...
    @Expose
    var datapemesanan: Pemesanan?=null
    ...
    class Pemesanan{
        ...
        class Driver{
            ...
            class Kendaraan{
                ...
                @Expose
                var type_kendaraan:String?=null

                @SerializedName("nomor_kendaraan")
                @Expose
                var nomor_kendaraan:String?=null

                @SerializedName("merk_kendaraan")
                @Expose
                var merk_kendaraan:String?=null
            }
        }
