...
class inpHP : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.btn_masukdua).setOnClickListener {
            login()
        }
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onCodeSent(
                ...
                val intent = Intent(applicationContext,inpHP::class.java)
    ...
    private fun login() {
        number = findViewById<EditText>(R.id.inp_noHP).text.trim().toString()
